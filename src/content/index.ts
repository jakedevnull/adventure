...
import { crossroads2099Ba } from "./crossroads-2099-ba.ts";
...
export const world: World = {
  start: "turning-house",
  landings: ["2099 BA", "1099 BA", "99 BA", "99 AA"],
  rooms: [turningHouse, crossroads2099Ba, turningHouse1099Ba, turningHouse99Ba, turningHouse99Aa],
};
